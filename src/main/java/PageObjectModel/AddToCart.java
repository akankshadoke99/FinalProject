...
public class AddToCart {
	...
	private By addtocart=By.xpath("(//span[@class='hidden-xs hidden-sm hidden-md'])[7]");
	private By addtocartsamsung=By.xpath("(//span[@class='hidden-xs hidden-sm hidden-md'])[8]");
	private By price=By.xpath("(//p[@class='price'])[1]");
